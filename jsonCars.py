...
async def trax(model:str, k:str, p:int, i:str | None = Query(default=None)):
    PRM = "https://api.encar.com/search/car/list/premium?"
    qty = 0
    ...
    if model == "Trax" and k == "gm" and p == 1:
        trax1 = await run(PRM+f'count=true&q=(And.Hidden.N._.MultiViewHidden.N._.(C.CarType.Y._.(C.Manufacturer.%EC%89%90%EB%B3%B4%EB%A0%88(GM%EB%8C%80%EC%9A%B0_)._.(C.ModelGroup.%ED%8A%B8%EB%9E%99%EC%8A%A4._.Model.%EB%8D%94+%EB%89%B4+%ED%8A%B8%EB%9E%99%EC%8A%A4.))))&sr=%7CModifiedDate%7C0%7C20')
        if i is None:
            return trax1
        # iD
    ...
    if model == "Trax" and k == "gm" and p == 2:
        qty=20
        trax2 = await run(PRM+f'count=true&q=(And.Hidden.N._.MultiViewHidden.N._.(C.CarType.Y._.(C.Manufacturer.%EC%89%90%EB%B3%B4%EB%A0%88(GM%EB%8C%80%EC%9A%B0_)._.(C.ModelGroup.%ED%8A%B8%EB%9E%99%EC%8A%A4._.Model.%EB%8D%94+%EB%89%B4+%ED%8A%B8%EB%9E%99%EC%8A%A4.))))&sr=%7CModifiedDate%7C{qty}%7C20')
        return trax2

    if model == "Trax" and k == "gm" and p == 3:
        qty=40
        trax3 = await run(PRM+f'count=true&q=(And.Hidden.N._.MultiViewHidden.N._.(C.CarType.Y._.(C.Manufacturer.%EC%89%90%EB%B3%B4%EB%A0%88(GM%EB%8C%80%EC%9A%B0_)._.(C.ModelGroup.%ED%8A%B8%EB%9E%99%EC%8A%A4._.Model.%EB%8D%94+%EB%89%B4+%ED%8A%B8%EB%9E%99%EC%8A%A4.))))&sr=%7CModifiedDate%7C{qty}%7C20')
        return trax3

    if model=='Trax'and k=="gm"and p==4:
        qty=60
        trax4 = await run(PRM+f'count=false&q=(And.Hidden.N._.MultiViewHidden.N._.(C.CarType.Y._.(C.Manufacturer.%EC%89%90%EB%B3%B4%EB%A0%88(GM%EB%8C%80%EC%9A%B0_)._.(C.ModelGroup.%ED%8A%B8%EB%9E%99%EC%8A%A4._.Model.%EB%8D%94+%EB%89%B4+%ED%8A%B8%EB%9E%99%EC%8A%A4.))))&sr=%7CModifiedDate%7C{qty}%7C20')
        return trax4

    # 2023~Crossover
    if model=='Trax'and k=="23"and p==1:
        qty=0
        trax2023_1 = await run(PRM+f'count=false&q=(And.Hidden.N._.(C.CarType.Y._.(C.Manufacturer.%EC%89%90%EB%B3%B4%EB%A0%88(GM%EB%8C%80%EC%9A%B0_)._.(C.ModelGroup.%ED%8A%B8%EB%9E%99%EC%8A%A4._.Model.%ED%8A%B8%EB%9E%99%EC%8A%A4+%ED%81%AC%EB%A1%9C%EC%8A%A4%EC%98%A4%EB%B2%84.))))&sr=%7CModifiedDate%7C{qty}%7C20')
        return trax2023_1

    if model=='Trax'and k=="16"and p==1:
        qty=0
        trax2016_1 = await run(PRM+f'count=false&q=(And.Hidden.N._.(C.CarType.Y._.(C.Manufacturer.%EC%89%90%EB%B3%B4%EB%A0%88(GM%EB%8C%80%EC%9A%B0_)._.(C.ModelGroup.%ED%8A%B8%EB%9E%99%EC%8A%A4._.Model.%EB%8D%94+%EB%89%B4+%ED%8A%B8%EB%9E%99%EC%8A%A4.))))&sr=%7CModifiedDate%7C{qty}%7C20')
        return trax2016_1
