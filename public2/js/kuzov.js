...
//     });
  ...
  if (WL$.includes(`Chevy=Trax`) ) {
      $(`.kuzova`).append(`
          <option value="23">2023~Crossover</option>
          <option value="16">2016~2022</option>
          `)
   } if (WL$.includes('23') ) {
      $('select.kuzova option:contains("2023")').prop('selected', true)

   } if (WL$.includes('16') ) {
      $('select.kuzova option:contains("2016")').prop('selected', true)
   }
